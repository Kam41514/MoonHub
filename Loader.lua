...
local BUTTON_BG = Color3.fromRGB(25, 25, 29)
local BUTTON_HOVER = Color3.fromRGB(34, 30, 40)
...
title.Position = UDim2.new(0, 35, 0, 17)
...
beta.Position = UDim2.new(0, 128, 0, 22)
beta.BackgroundColor3 = Color3.fromRGB(42, 30, 50)
...
closeStroke.Color = Color3.fromRGB(65, 50, 75)
...
{
BackgroundColor3 = Color3.fromRGB(55, 30, 35),
...
divider.BackgroundColor3 = Color3.fromRGB(70, 70, 76)
...
stroke.Color = Color3.fromRGB(62, 55, 68)
...
arrow.Text = "›"
arrow.TextColor3 = Color3.fromRGB(115, 110, 120)
arrow.TextSize = 23
...
button.MouseLeave:Connect(function()
	...
	TweenService:Create(
		...
		TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
		{
			TextColor3 = Color3.fromRGB(115, 110, 120)
		}
	):Play()
end)
...
footer.TextColor3 = Color3.fromRGB(105, 102, 110)
footer.TextSize = 10
...
notification.BackgroundColor3 = Color3.fromRGB(22, 22, 25)
...
local stroke = Instance.new("UIStroke")
stroke.Color = Color3.fromRGB(90, 60, 110)
stroke.Thickness = 0.7
